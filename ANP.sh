clear
figlet -f bigmono9 "ANP Spam" | lolcat
echo "\033[38;1m ------------------------------------------------------------------"|lolcat
echo "\033[31;1m  "
echo "\033[36;1m" "                    AUTHOR : Hacker online && ~Y"
echo "\033[36;1m" "                    		☆¥4Z@G4M¥⁩"
echo "\033[35;1m #Budidayakan Spam Mantan#"
echo "\033[34;1m" "https://github.com/Hacketindonedia1"
...
toilet -f lean  "INFO"
echo "Dibuat oleh "
echo "Hacker online | ☆¥4Z@G4M¥⁩"
echo "Kunjungi github kami : "
echo "https://github.com/Hacketindonedia1"
fi
